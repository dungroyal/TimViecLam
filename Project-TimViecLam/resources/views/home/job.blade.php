                            ...
                            <div class="row job-item-show">
                                    ...
                                    <div class="col-sm-10 col-lg-10 col-xl-10 company_name">
                                        ...
                                        <div class="job_company">
                                            <div class="name">
                                                <a href="/company/{{$company->id}}" target="_blank" title="{{$company->name_company}}" data-toggle="tooltip">
                        ...
                        <div class="col-md-6 col-lg-4 job-over-item">
                            <div class="row job-item-show">
                                    <div href="#" class="col-sm-2 col-lg-2 col-xl-2 job-item-show__logo">
                                        @if ($company->logo != null)
                                            <img src="{{ asset('/') }}{{$company->logo}}" alt="{{$job->name_job}}"/>
                                        @else
                                    ...
                                    <div class="col-sm-10 col-lg-10 col-xl-10 company_name">
                                        ...
                                        <div class="job_company">
                                            <div class="name">
                                                <a href="{{Route('company',['id'=>$company->id])}}" target="_blank" title="Cali-land, Inc tuyển dụng" data-toggle="tooltip">
                                                    <span>{{$company->name_company}}</span>
                                                </a>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#jobData').on('click', '.job-over-item', function() {
            ...
            $("#jobDetailData").html('<div class="text-input__loading"><div class="text-input__loading--line"></div><div class="text-input__loading--line"></div><div class="text-input__loading--line"></div><div class="text-input__loading--line"></div><div class="text-input__loading--line"></div><div class="text-input__loading--line"></div><div class="text-input__loading--line"></div></div>');
