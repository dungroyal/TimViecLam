                              ...
                              <div class="container">
                                <div class="row">
                                  <div class="col-md-1">
                                    ...
                                    @else
                                    <img src="{{ asset('/images/logo/timvieclam-placeholder.png') }}" alt="{{$jobs_detail->name_job}}" alt="TVL"/>
                                    @endif
                                    </div>
                                                ...
                                                <div class="job-item-company-detail">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <p class="j_title text_ellipsis">
                                                            <a href="{{ Route('job-detail',['id' => $job->id]) }}" data-toggle="tooltip" target="_blank"
