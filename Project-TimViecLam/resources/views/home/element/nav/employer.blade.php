    ...
    <div class="ml-auto">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="form-inline my-2 my-lg-0 navbar-nav font-weight-bold font-header">
                ...
                <li class="nav-item nav-item__cusstom ml-3">
                    <a class="nav-link text-blue" href="{{ Route('all-profile') }}">
                ...
                <li class="nav-item ml-2 btn mb-3 mb-md-0 ml-md-3">
                    <div class="dropdown-btn-custom">
                        <div class="dropdown-btn-custom__select">
                            <img src="https://ui-avatars.com/api/?background=fffff&name={{ App\Models\Company::where('employer_id',Auth::guard('employer')->user()->id)->first()->name_company }}" alt="" width="10px" class="mr-2 rounded rounded-circle-20">
                            <p class="dropdown-btn-custom__selected text_ellipsis max-w-300">{{ App\Models\Company::where('employer_id',Auth::guard('employer')->user()->id)->first()->name_company }}</p>
                        ...
                        <ul class="dropdown-btn-custom__list">
                            ...
                            <li onclick="location.href='{{route('employer.listJobPost')}}';" class="dropdown-btn-custom__item">
