...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2020 at 08:04 PM
...
(3, 1, 33, 1, 1, '2020-12-19 07:52:42', '2020-12-19 07:52:42');
...
INSERT INTO `companies` (`id`, `employer_id`, `name_company`, `personnel_size`, `career_id`, `phone`, `address`, `city`, `description`, `website`, `fax`, `logo`, `business_license`, `name_contact`, `phone_contact`, `email_contact`, `address_contact`, `servece`, `status`, `note`, `created_at`, `updated_at`) VALUES
(1, 1, 'Công ty TNHH TM-DV Công Nghệ Thành Nhân', 1, 32, '0901415416', '992 Âu Cơ, Phương 14, Tân Bình', 51, 'Đang cập nhật', 'www.ThanhNhanComputer.vn', '0312451578', 'uploads/images/RisE7hNKA63uSk7d7HcNABQuMSH0LC81LG3vwVZU.png', 'uploads/files/QSgTraTcIL8SlFjQdGGtSsXql6MAlHVhVrtEWZVD.pdf', 'Phạm Văn Chính', '0901415416', 'Chinhpham770@gmail.com', '992 Âu Cơ, Phương 14, Tân Bình', NULL, 1, 'Chúc mừng công ty Công ty TNHH TM-DV Công Nghệ Thành Nhân đã được duyệt', '2020-11-29 12:40:52', '2020-12-21 11:55:54'),
(2, 2, 'Công ty Cổ phần Phát triển Công nghệ Sài Gòn Web', 100, 22, '0708337474  ', '108/ 15 Cộng Hòa, phường 4, quận Tân Bình.', 59, 'Đang cập nhật', 'trishhopkinson.com', NULL, NULL, NULL, 'Ái Hồng', '0798.58.1133 ', 'mai112233@yahoo.com.vn', 'Đang cập nhật', NULL, 1, '', NULL, '2020-12-19 12:22:56'),
...
(8, 8, 'Công ty TNHH SUNSHINE VN', 10, 5, '03265877889 ', '1/2 Nguyễn Đình Khơi, phường 4, quận Tân Bình.', 51, 'Đang cập nhật', 'sunshine.vn', NULL, NULL, NULL, 'Ái Thy', '0987462844 ', 'phamtham31290@gmail.com', 'Đang cập nhật', NULL, 1, 'Chúc mừng công ty Công ty TNHH SUNSHINE VN đã được duyệt', NULL, '2020-12-19 21:23:15'),
...
(79, 79, 'Thành Nhân Computer', 0, 22, '0901415416', 'GO VAP, GO VAP', 51, NULL, NULL, NULL, NULL, NULL, 'Phạm Văn Chính', '0901415416', 'ntd@gmail.com', 'GO VAP, GO VAP', NULL, 1, 'Chúc mừng công ty Thành Nhân Computer đã được duyệt', NULL, '2020-12-21 09:18:08');
...
INSERT INTO `degree_details` (`id`, `id_profile`, `university`, `faculty`, `certificate`, `major`, `ranked`, `detail`, `month_start`, `year_start`, `graduation_month`, `graduation_year`, `status`) VALUES
(49, 6, 'FPT Polytechnic', 'CNTT', 'Cao đẳng chính quy', 'TKTW', 'Giỏi', NULL, '8', '2018', '12', '2020', 1),
(68, 8, 'FPT Polytechnic', 'CNTT', 'Cao đẳng chính quy', 'TKTW', 'Chọn xếp loại', 'Đã tốt nghiệp', '0', '2018', '7', '2020', 1);
...
(79, 'ntd@gmail.com', NULL, '$2y$10$TYVbB/0iHq69xmEjYDs/FuRkMtdNiP2cYxeRAd6uv4DgTkrvlQ0JK', NULL, NULL, '2020-12-17 15:28:03', '2020-12-17 15:28:03');
...
INSERT INTO `experience_detail` (`id`, `id_profile`, `position`, `company`, `month_start`, `year_start`, `month_end`, `year_end`, `note`, `status`) VALUES
(7, 6, 'Nhân viên kĩ thuật', 'Thành Nhân Computer', '9', '2018', '12', '2020', '', '1');
...
CREATE TABLE `job` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '0: disable, 1 active, 2 viêc làm hot, 3 việc làm gấp, 4 tạm chặn',
...
(31, 'Lê Anh Tú', 'ntd2020@gmail.com', NULL, '$2y$10$4bll3HxWRofR3eFissZSdeOjzwdrYE4Z1hzCCXHOGhXjvvGWoodsi', '0301415416', '1', NULL, '2020-12-16 02:39:17', '2020-12-16 07:40:22'),
(32, 'DOAN QUOC DUNG', 'dungdqps08542@fpt.edu.vn', NULL, '$2y$10$2BibxktkEoQRgQLEcuF.9.itZjLYYYTwnKrf2nKmVwvCkkytiWlKi', '0328050520', '1', NULL, '2020-12-17 14:23:28', '2020-12-17 14:29:00'),
(33, 'Đoàn Quốc Dũng', 'doanquocdung55@gmail.com', NULL, '$2y$10$YEKYvzIuQxNyyyC/4Iv6DuH49/X7VG5fkDoRNAkGl5aIZ9tA4K8kC', '0398022720', '1', NULL, '2020-12-17 15:11:21', '2020-12-18 21:05:21');
...
CREATE TABLE `profiles` (
  ...
  `attached_profile` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `profiles` (`id`, `job_seeker_id`, `address`, `gender`, `marital_status`, `birthday`, `avatar`, `position`, `type_job_id`, `career_id`, `grade_id`, `salary_id`, `degree_id`, `experience_id`, `work_location`, `career_goals`, `career_description`, `attached_profile`, `status`, `note`, `view`, `created_at`, `updated_at`) VALUES
(6, 31, '992 Âu cơ, Phường 14, Tân Bình', 0, 0, '2000-12-05', NULL, 'Web Deverloper', 1, 22, 1, 5, 6, 4, 51, 'Mong muốn tìm được nơi có cơ hội cống hiến bản thân tốt', 'Thăng tiến trong công việc', '', 2, '', 3, '2020-12-16 02:39:21', '2020-12-20 10:41:29'),
(8, 33, '34D Đường số 12, P11, Gò Vấp', 0, 0, '2020-12-16', 'uploads/images/AMW2JoSScyVJVnWFgTk3QQk1qDTmnF1q5NROjywX.png', 'Web Deverlop', 1, 22, 2, 4, 6, 6, 51, 'Mong muốn tìm được nơi có cơ hội cống hiến bản thân tốt', '123', 'uploads/files/XrlcYmIaBOjDI0JyXJmsNlzGCzcRSqZBnpx2kv6c.pdf', 0, 'Thiếu thiếu', 158, '2020-12-17 15:11:25', '2020-12-21 19:02:16');
...
INSERT INTO `save_job` (`id`, `job_seeker_id`, `job_id`, `created_at`, `updated_at`) VALUES
(1, 33, 1, '2020-12-21 18:50:03', '2020-12-21 18:50:03'),
(2, 33, 16, '2020-12-21 19:03:27', '2020-12-21 19:03:27'),
(4, 33, 107, '2020-12-21 19:04:03', '2020-12-21 19:04:03');
...
INSERT INTO `skill_detail` (`id`, `id_profile`, `professional_skills`, `other_skill`) VALUES
(15, 8, 'Magnam velit id ip', 'Kỹ năng tổ chức,Kỹ năng giao tiếp,Lập kế hoạch,Dễ dàng thích nghi với môi trường mới');
