...
<head>
    ...
    <!-- Title Page-->
    <title>Nhà Tuyển Dụng | Tìm Việc Làm</title>
    ...
    <link href="{{ asset('user') }}/vendor/vector-map/jqvmap.min.css" rel="stylesheet" media="all">
...
<body class="animsition">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>Tổng quang
                                <span class="arrow">
    ...
    <script src="{{ asset('user') }}/vendor/vector-map/jquery.vmap.js"></script>
    <script src="{{ asset('user') }}/vendor/vector-map/jquery.vmap.min.js"></script>
    <script src="{{ asset('user') }}/vendor/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="{{ asset('user') }}/vendor/vector-map/jquery.vmap.world.js"></script>
