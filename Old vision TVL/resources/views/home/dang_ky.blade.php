...
<div class="margin_top_custom"></div>
        <div id="login-box">
            <div class="left-box">
                ...
                <a href="/dang-ky/ntd"  class="right-box_btn background_cam btn-hover">Đăng Ký nhà tuyển dụng</a>
            </div>
            <div class="right-box">
                <div class="right-box_title">
                    <h1>Ứng Viên</h1>
                ...
                <a href="/dang-ky/uv"  class="right-box_btn background_xanh btn-hover">Đăng Ký Ứng Viên</a>
            </div>
        </div>
@endsection
